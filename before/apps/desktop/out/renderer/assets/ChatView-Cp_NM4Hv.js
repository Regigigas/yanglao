import { X as createVNode, l as defineComponent, o as onMounted, b as onBeforeUnmount, U as createBlock, W as withCtx, u as unref, r as ref, n as nextTick, V as openBlock, a3 as createBaseVNode, k as createTextVNode, a9 as toDisplayString, a1 as createElementBlock, a6 as renderList, F as Fragment, a7 as createCommentVNode, a4 as withKeys, a5 as withModifiers, J as normalizeClass } from "./vendor-vue-Ccw0-9Al.js";
...
import { u as useMessage, B as Button, V as NButtonGroup, o as NTag, D as NEmpty, C as NSpin, l as NInput, S as NTabs, T as NTabPane, $ as NCheckboxGroup, h as NModal, x as NBadge, m as NCheckbox } from "./vendor-naive-B-M0K3Pm.js";
...
const Add = IconWrapper("add", false, function(props) {
...
const CloudStorage = IconWrapper("cloud-storage", true, function(props) {
  return createVNode("svg", {
    "width": props.size,
    "height": props.size,
    "viewBox": "0 0 48 48",
...
const Computer = IconWrapper("computer", false, function(props) {
  return createVNode("svg", {
    "width": props.size,
    "height": props.size,
    "viewBox": "0 0 48 48",
...
const Send = IconWrapper("send", true, function(props) {
  return createVNode("svg", {
    "width": props.size,
    "height": props.size,
    "viewBox": "0 0 48 48",
            ...
            createVNode(unref(NButtonGroup), null, {
              default: withCtx(() => [
                ...
                createVNode(unref(Button), {
                  ...
                  icon: withCtx(() => [
                    createVNode(unref(CloudStorage), {
                      class: "chat-button-icon",
                      theme: "outline",
                      size: 16,
                      "stroke-width": 3
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(conversations.value, (conversation) => {
                  return openBlock(), createElementBlock("button", {
                    ...
                    createBaseVNode("span", _hoisted_7, [
                      conversation.type === "G" ? (openBlock(), createBlock(unref(Peoples), {
                        key: 0,
                        theme: "outline",
                        size: 20,
                        "stroke-width": 3
...
const ChatView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-029ad62f"]]);
export {
  ChatView as default
};
