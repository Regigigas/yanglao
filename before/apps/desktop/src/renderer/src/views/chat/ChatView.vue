  ...
  <BasePage title="消息中心">
    <div class="chat-mode-bar">
      <NButtonGroup>
        ...
        >
          <template #icon><Icon icon="ion:desktop-outline" /></template>
          本地聊天
        </NButton>
        <NButton
          size="small"
        ...
        >
          <template #icon><Icon icon="ion:cloud-outline" /></template>
          线上聊天
        </NButton>
      </NButtonGroup>
        ...
        <div class="conversation-list">
          ...
          >
            <span class="conversation-avatar">
              <Icon :icon="conversation.type === 'G' ? 'ion:people' : 'ion:person'" />
            </span>
        ...
        <template v-if="selected">
          ...
          <footer class="composer">
            ...
            <NButton type="primary" :loading="sending" :disabled="!draft.trim()" @click="sendMessage">
              <template #icon><Icon icon="ion:send" /></template>
              发送
            </NButton>
          </footer>
        </template>
      ...
      <NTabs v-model:value="createMode" type="segment">
        <NTabPane name="direct" tab="私聊">
          <div class="contact-search">
            ...
            <NButton @click="searchContacts"><template #icon><Icon icon="ion:search" /></template></NButton>
          </div>
...
<style scoped>
  ...
  .conversation-avatar svg { width: 21px; height: 21px; }
  .conversation-copy,
  .conversation-title,
