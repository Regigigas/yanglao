...
<template>
  <NLayout has-sider style="height: 100vh">
    ...
    >
      ...
      >
        <span v-if="!collapsed" class="text-base font-bold text-primary"
          >养老管理系统</span
        >
        <span v-else class="i-ion:home text-primary text-xl" />
      </div>
          ...
          <NTooltip>
            <template #trigger>
              <NBadge :type="syncStatusColor" dot>
                <i
                  class="i-ion:sync-outline text-lg cursor-pointer hover:text-primary"
        ...
        <NSpace align="center" class="shrink-0">
          ...
          >
            <template #trigger>
              ...
              >
                <i
                  class="i-ion:notifications-outline text-xl cursor-pointer hover:text-primary"
                />
              </NBadge>
            </template>
          ...
          <!-- 主题切换 -->
          <i
            :class="isDark ? 'i-ion:sunny-outline' : 'i-ion:moon-outline'"
    ...
    >
      <template #header>
        <NSpace align="center">
          <i class="i-ion:alarm text-xl text-warning" style="color: #f0a020" />
