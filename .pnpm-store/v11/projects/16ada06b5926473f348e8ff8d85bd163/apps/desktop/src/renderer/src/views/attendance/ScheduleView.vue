...
import { AlarmClock, CalendarDot } from '@icon-park/vue-next'
  ...
  <BasePage title="排班管理">
                ...
                <div v-else class="cell-content">
                  ...
                  >
                    ...
                    <NTooltip v-if="reminderMap[sc.id]">
                      <template #trigger>
                        <AlarmClock class="shift-reminder-icon" theme="outline" :size="12" :stroke-width="3" />
                      </template>
    ...
    >
      ...
      <div class="date-banner mb-4">
        <CalendarDot class="date-banner-icon" theme="outline" :size="18" :stroke-width="3" />
      ...
      <NForm :model="editForm" label-placement="left" label-width="80">
        ...
        <div class="reminder-section">
          <div class="reminder-section__header" @click="enableReminder = !enableReminder">
            <NSpace align="center">
              <AlarmClock class="reminder-title-icon" theme="outline" :size="16" :stroke-width="3" />
