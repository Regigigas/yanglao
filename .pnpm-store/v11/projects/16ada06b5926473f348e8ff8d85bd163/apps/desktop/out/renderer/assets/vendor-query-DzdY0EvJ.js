import { i as isRef, u as unref, r as ref, n as nextTick } from "./vendor-vue-C6_copC_.js";
...
var MutationCache$1 = class MutationCache extends Subscribable {
  constructor(config = {}) {
    super();
    this.config = config;
...
var QueryCache$1 = class QueryCache extends Subscribable {
  constructor(config = {}) {
    super();
    this.config = config;
...
var QueryCache2 = class extends QueryCache$1 {
  find(filters) {
...
var MutationCache2 = class extends MutationCache$1 {
  find(filters) {
    return super.find(cloneDeepUnref(filters));
  }
  findAll(filters = {}) {
...
var QueryClient2 = class extends QueryClient$1 {
  constructor(config = {}) {
