...
import { X as createVNode } from "./vendor-vue-Ccw0-9Al.js";
const AlarmClock = IconWrapper("alarm-clock", true, function(props) {
...
const CalendarDot = IconWrapper("calendar-dot", false, function(props) {
  return createVNode("svg", {
    "width": props.size,
    "height": props.size,
    "viewBox": "0 0 48 48",
