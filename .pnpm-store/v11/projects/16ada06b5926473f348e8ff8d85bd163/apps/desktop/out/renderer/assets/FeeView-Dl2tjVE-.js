...
import { l as defineComponent, r as ref, U as createBlock, W as withCtx, u as unref, V as openBlock, X as createVNode, k as createTextVNode, a7 as createCommentVNode, q as h, a1 as createElementBlock, a6 as renderList, F as Fragment, a9 as toDisplayString, c as computed, a2 as useRouter } from "./vendor-vue-Ccw0-9Al.js";
import { f as formatDateTime } from "./validators-BfKhytEl.js";
import { u as usePageRefresh } from "./usePageRefresh-D9DPHtoi.js";
import { u as useMessage, T as NTabPane, g as NCard, v as NSpace, B as Button, P as NGrid, M as NGridItem, O as NStatistic, H as NDatePicker, X as NDivider, J as NSelect, o as NTag, S as NTabs, j as NForm, k as NFormItem, l as NInput, U as NInputNumber, h as NModal } from "./vendor-naive-B-M0K3Pm.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const billColumns = [
      ...
      { title: "操作", key: "actions", width: 220, render: (r) => h(NSpace, null, { default: () => [
        ...
        h(Button, { size: "small", type: "success", disabled: r.status !== "paid", onClick: () => router.push({ name: "Invoice", query: { billId: r.id } }) }, "开票")
      ] }) }
    ];
