...
const api = {
  ...
  roomType: {
    list: (activeOnly) => electron.ipcRenderer.invoke("room-type:list", activeOnly),
    create: (data) => electron.ipcRenderer.invoke("room-type:create", data),
    update: (id, data) => electron.ipcRenderer.invoke("room-type:update", { id, data }),
    delete: (id) => electron.ipcRenderer.invoke("room-type:delete", id)
  },
  corridor: {
    list: (buildingId) => electron.ipcRenderer.invoke("corridor:list", buildingId),
    create: (data) => electron.ipcRenderer.invoke("corridor:create", data),
    update: (id, data) => electron.ipcRenderer.invoke("corridor:update", { id, data }),
    delete: (id) => electron.ipcRenderer.invoke("corridor:delete", id)
  },
  room: {
    ...
    generate: (data) => electron.ipcRenderer.invoke("room:generate", data)
  },
  bed: {
